...
<div class="p-2">
    <div class="row mb-3 align-items-end">
        <div class="col-sm-2">
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#select-product_modal">Select Product</button>
        </div>
			...
			$(document).ready(function(){
				...
				productTable = $("#products_table").DataTable({
					...
					"columns": [
						...
						{ 
							"data": "code",
							"render" : (data) => `<button class="btn btn-primary" id="select-product_btn" data-id="${data}"><i class="fas fa-check fa-2xs" ></i></button>`,
						},
					]
				});
